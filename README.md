# atTwitter
atTwitter app is part of CodePath Spring 2018 IOS University course lab. The app is a simple Twitter client that allows users to view their feed and post tweets.
# Project 5 - *atTwitter App*

**atTwitter** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
<img src='https://i.imgur.com/kyu1yHZ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
